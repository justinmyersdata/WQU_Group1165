...
import pandas as pd
import numpy as np
from functions.pandas_funcs import buy_or_sell
...
def generate_data(tickers: list, start: str, end: str, band:int, windows: list, initial: float) -> pd.DataFrame: 
    ...
    for ticker in tickers:
        ...
        fixed_columns = ['date','ticker','open','close'
